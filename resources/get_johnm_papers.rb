...
open("/home/j9/Desktop/johnmuir/data/list_of_john_muir_papers.txt", "wb") do |file|
...
letterlist.each do | n|
  ...
  open("/home/j9/Desktop/johnmuir/data/xml/john_muir_papers_xml_s" + name[-1] + ".xml", "wb") do |file|
    file.write(doc)
  end
  ...
  plain_text.each do | p |
    ...
    s4.each do | s |
      ...
      open("/home/j9/Desktop/johnmuir/data/plaintext/john_muir_papers_txt_" + name[-1] + ".txt", "w:UTF-8") do |file|
        file.write(name[-1] + "\n\n")
