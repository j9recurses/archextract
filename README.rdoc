...
### Python libraries
scipy, numpy, nltk, la (larry), bottleneck, mysql-connector-python
...
##Email Server
-- this uses a email server; you can either use google or use an email server installed on the server from whe
from where this is run
